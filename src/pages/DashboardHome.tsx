...
import { MiniTour, DASHBOARD_TOUR } from "@/components/dashboard/MiniTour";
...
export const DashboardHome = ({
    ...
    return (
        <div className="space-y-12">
            ...
            {/* Onboarding Guide - Show if no testimonials yet */}
            {(!testimonials || testimonials.length === 0) && (
                <OnboardingGuide
                    ...
                    latestSpaceSlug={spaces && spaces.length > 0 ? spaces[0].slug : null}
                />
            )}

            {/* Top Section: Analytics & Insights - Only show if we have data */}
            {testimonials.length > 0 && (
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6" data-tour-id="dashboard-stats">
                    {/* Main Curve Chart */}
            ...
            {/* Main Section: New Leads (Testimonials) - Only show if we have data */}
            {testimonials.length > 0 && (
            ...
            <div className={`grid grid-cols-1 ${testimonials.length > 0 ? 'lg:grid-cols-2' : 'lg:grid-cols-1'} gap-8 pb-12`}>
                {/* Active Collections */}
                <div className="space-y-6">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            <h3 className="text-2xl font-light text-zinc-900">Your Collections</h3>
                            <MiniTour
                    ...
                    <div className="grid gap-4" data-tour-id="dashboard-spaces">
                        {/* New Collection Button */}
                        <button
                            data-tour-id="create-collection-btn"
                        ...
                        >
                            ...
                            <span className="text-sm font-bold text-zinc-400 group-hover:text-black transition-colors">Create New Collection</span>
                        </button>
                        ...
                        {spaces.map((space) => (
                            <div
                                ...
                                className="group flex items-center justify-between p-4 bg-white/60 backdrop-blur-md rounded-xl border border-zinc-200/60 hover:border-black/20 hover:shadow-lg hover:bg-white transition-all cursor-pointer relative"
                            >
                                ...
                                <div className="flex items-center gap-2">
                                    <Button
                                        size="sm"
                                        variant="outline"
                                        className="h-8 rounded-lg text-xs font-medium border-zinc-200 hover:bg-zinc-900 hover:text-white hover:border-zinc-900 transition-colors hidden sm:flex"
                                    ...
                                    <DropdownMenu>
                                        ...
                                        <DropdownMenuContent align="end">
                                            ...
                                            <DropdownMenuItem onClick={(e) => { e.stopPropagation(); copyCollectionLink(space.slug); }}>
                ...
                {/* Recent Activity Feed - Only show if we have data */}
                {testimonials.length > 0 && (
                    <div className="space-y-6" data-tour-id="dashboard-recent">
